      ...
      <section class="education" id='Education' >
        ...
        <div className='box-container' >
          <div class="box" >
              ...
              <span style={{color: darkMode ? "white" : ""}} >Batch: 2016-2020<br/>
          ...
          <i class="fa-solid fa-graduation-cap" style={{color: darkMode ? "white" : ""}}>...................</i>
            ...
            <span style={{color: darkMode ? "white" : ""}}>Batch: 2014-2016<br/>Kerala HSC</span>
          </div>
          <div class="box">
          <i class="fa-solid fa-graduation-cap"  style={{color: darkMode ? "white" : ""}}>...................</i>
            <span style={{color: darkMode ? "white" : ""}}>Secondary Education</span>
            <span style={{color: darkMode ? "white" : ""}}>Batch: 2013-2014
            <br/>Kerala SSC</span> 
          </div>
        </div>
